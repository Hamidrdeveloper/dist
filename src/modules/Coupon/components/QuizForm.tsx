...
import QuizArrayInput from '@src/shared/components/QuizArray/QuizArrayInput';
...
function QuizForm({ onSubmit, isPending, initialValues }: FormProps<Coupon>): ReactElement {
