...
const SelfRevenue = ({ id }: { id: number }): ReactElement => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`partner-dashboard/${id}/self-revenue`, { params: selectedDateRange })
      ...
      {isLoading ? (
        ...
        <div className="content">
          ...
          <Row justify="center" align="middle">
            <SimpleBarChart data={data?.chart_data[String(value)] ?? []} />
          </Row>
        </div>
      )}
    </MainContainer>
